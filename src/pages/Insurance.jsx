...
export default function Insurance() {
  ...
  const [formData, setFormData] = useState({
    vehicle_id: "685fa5c907cede536311ad85",
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-600 mt-1">
              Manage your vehicle insurance policies and quotes
            </p>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="685fa5c907cede536311ad85">
                          Corolla
                        </SelectItem>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    {coverageOptions.map((option) => (
                      ...
                      >
                        <Checkbox
                          id={option.value}
                          checked={formData.coverage_required.includes(
                            option.value
                          )}
                          onCheckedChange={(checked) =>
                            handleCoverageChange(option.value, checked)
                          }
                        />
          ...
          <Card className="bg-white/80 backdrop-blur-sm shadow-lg">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-slate-600 mb-6">
                Start by requesting a quote for your vehicle insurance
              </p>
              <Button
