...
export default function ServiceRequests() {
  ...
  const loadData = async () => {
    try {
      ...
      setServiceProviders(
        allUsers.filter((user) => user.user_type === "service_provider")
      );
    } catch (error) {
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 pt-4 border-t border-slate-200">
                      ...
                      {service.status === "assigned" && (
                        <Button
                          onClick={() =>
                            handleStatusUpdate(service.id, "in_progress")
                          }
                          size="sm"
                      ...
                      {service.status === "in_progress" && (
                        <Button
                          onClick={() =>
                            handleStatusUpdate(service.id, "completed")
                          }
                          size="sm"
                      ...
                      {service.status !== "completed" &&
                        service.status !== "cancelled" && (
                          <Button
                            onClick={() =>
                              handleStatusUpdate(service.id, "cancelled")
                            }
                            size="sm"
                            variant="outline"
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAssignFormData((prev) => ({
                      ...prev,
                      estimated_cost: parseInt(e.target.value),
                    }))
                  }
